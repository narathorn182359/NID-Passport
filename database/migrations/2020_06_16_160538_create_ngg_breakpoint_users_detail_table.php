...
class CreateNggBreakpointUsersDetailTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ngg_breakpoint_users_detail', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('ngg_breakpoint_users_detail');
    }
}
