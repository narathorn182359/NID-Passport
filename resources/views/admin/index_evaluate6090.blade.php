                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control float-right" id="reservation_60"  name="reservation_60" required autocomplete="off">
                            </div>
                            <!-- /.input group -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control float-right" id="reservation_90" name="reservation_90" required autocomplete="off">
                            </div>
                        </div>
                    </div>
