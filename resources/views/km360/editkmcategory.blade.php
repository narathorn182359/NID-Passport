...
<div class="row">
    ...
    <div class="col-lg-12">
      ...
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
        <form class="user"  action="{{url('/editnew_detail_km_category/'.$category->id)}}" method="POST"  enctype="multipart/form-data">
            @csrf
                <div class="form-group">
                 <input type="file"   class="form-control form-control-user" name="image[]"   multiple>
                  </div>
                <div class="form-group">
                  <input type="text" class="form-control form-control-user" id="km_title" placeholder="หัวเรื่องความรู้" name="km_title" required  value="{{$category->km_title}}">
                </div>
                <div class="form-group">
